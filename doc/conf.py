# -*- coding: utf-8 -*-
#
# Centurion documentation build configuration file, created by
...
htmlhelp_basename = 'Centuriondoc'
...
latex_documents = [
  ('index', 'Centurion.tex', u'Centurion Documentation',
